...
const TotpDeviceSchema = zod_1.z
  .object({
    ...
    skew: zod_1.z
      .number()
      .optional()
      .describe("Allowed skew for TOTP in seconds"),
    period: zod_1.z
      .number()
      .optional()
...
const ThirdPartyLoginMethodSchema = BaseLoginMethodSchema.extend({
  ...
  thirdPartyUserId: zod_1.z
    .string()
    .describe("User ID from third party provider"),
...
exports.CreateUserParametersSchema = zod_1.z.object({
  ...
  loginMethods: zod_1.z
    ...
    .describe("Array of login methods"),
